...
" hi VisualNOS
" hi Search
hi Search 		ctermfg=0 		ctermbg=11 		cterm=none 		guifg=#333333 	guibg=#669999	gui=none
...
hi MatchParen	ctermfg=7		ctermbg=243		cterm=bold		guifg=#f6f3e8	guibg=#002029	gui=bold
